...
const UserSchema = new dbConnection_1.mongoose.Schema({
    ...
    personal_info: {
        ...
        profile_img: {
            type: String,
            default: () => {
                return `https://api.dicebear.com/6.x/${profile_imgs_collections_list[Math.floor(Math.random() * (profile_imgs_collections_list === null || profile_imgs_collections_list === void 0 ? void 0 : profile_imgs_collections_list.length))]}/svg?seed=${profile_imgs_name_list[Math.floor(Math.random() * (profile_imgs_name_list === null || profile_imgs_name_list === void 0 ? void 0 : profile_imgs_name_list.length))]}`;
            }
        },
    },
    social_links: {
