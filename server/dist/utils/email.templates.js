...
exports.errorEmailTemp = exports.welcomeEmailTemp = exports.passResetSuccessTemp = exports.passResetReqTemp = exports.verificationEmailTemp = void 0;
const env_1 = require("../configs/env");
const verificationEmailTemp = ({ verificationCode }) => {
    return `
<!DOCTYPE html>
<html lang="en">
...
<body
  ...
  <div style="text-align: center; padding: 30px 0; background-color: #4CAF50;">
    <!-- <img src="${env_1.ENV.backendUrl}/uploads/logo.png" alt="Your App Logo" style="width: 120px; height: auto; margin-bottom: 10px;" />  -->
  ...
  <div
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="${env_1.ENV.frontendUrl}/auth/verify-email?verification-code=${verificationCode}"
...
exports.verificationEmailTemp = verificationEmailTemp;
const passResetReqTemp = ({ resetURL }) => {
    return `
<!DOCTYPE html>
<html lang="en">
...
exports.passResetReqTemp = passResetReqTemp;
const passResetSuccessTemp = () => {
    return `
<!DOCTYPE html>
<html lang="en">
...
exports.passResetSuccessTemp = passResetSuccessTemp;
const welcomeEmailTemp = ({ name }) => {
    return `
  <!DOCTYPE html>
<html lang="en">
...
<body
  ...
  <!-- Header with Logo -->
  <div style="text-align: center; padding: 30px 0; background-color: #4CAF50;">
    <!-- <img src="${env_1.ENV.backendUrl}/uploads/logo.png" alt="Blogly Logo" style="width: 120px; height: auto; margin-bottom: 10px;" /> -->
  ...
  <div
    ...
    <ul>
      <li><a href="${env_1.ENV.frontendUrl}/blog/frontend-developer-roadmap-202511" target="_blank">Frontend Developer Roadmap 2025</a></li>
      <li><a href="${env_1.ENV.frontendUrl}/blog/backend-developer-roadmap-2025vh" target="_blank">Backend Developer Roadmap 2025</a></li>
    </ul>

    <div style="text-align: center; margin: 30px 0;">
      <a href="${env_1.ENV.frontendUrl}/editor"
        style="background-color: #4CAF50; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold; cursor: pointer;">
...
exports.welcomeEmailTemp = welcomeEmailTemp;
const errorEmailTemp = (error) => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
exports.errorEmailTemp = errorEmailTemp;
