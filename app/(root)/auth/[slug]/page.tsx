...

                {
                    slug == 'sign-in' ?
                        <div className='mt-6 text-center text-dark-grey text-xl'>
                            ...
                            <Link href="/auth/sign-up" className=' font-semibold underline text-blue-600'>Sign up</Link>
                        </div>
                        :
                        <div className='mt-6 text-center text-dark-grey text-xl'>
                            <span className=''>Already a member? </span>
                            <Link href="/auth/sign-in" className=' font-semibold underline text-blue-600'>Sign in</Link>
                        </div>
                }
            </div>
